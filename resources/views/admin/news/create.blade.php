        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data" role="form">
                                @include('admin.layouts.partials.errors')
                                {!! csrf_field() !!}
                                <input type="hidden" name="published" value="1">
                                <div class="form-group">
                                    <label for="category_id">Danh mục</label>
                                    <select type="text" name="parent_id" id="parent_id" class="form-control" value="{{ old('category_id') }}">
                                        <option value="">--</option>
